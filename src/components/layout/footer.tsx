...
import { Facebook, Twitter, Instagram, Youtube as YoutubeIcon } from 'lucide-react'; // Renamed Youtube to YoutubeIcon
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-8">
          <div>
            <Link href="/" className="inline-block mb-4">
              {/* Applying text-primary for the logo text color in footer as it's on a light background */}
              <TrtHaberLogo className="h-10 w-auto text-primary" /> 
            </Link>
            ...
            <div className="flex space-x-3 mt-4">
              ...
              <Link href="#" aria-label="Youtube" className="text-muted-foreground hover:text-primary transition-colors"><YoutubeIcon size={20} /></Link>
            </div>
          </div>
          <div>
